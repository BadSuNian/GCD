...
//  Gcd
//
//  Created by GP on 16/3/10.
//  Copyright © 2016年 GP. All rights reserved.
//
...
- (void)viewDidLoad {
    ...
    UIButton * serial = [[UIButton alloc] initWithFrame:CGRectMake(100, 100, 100, 50)];
    [serial setTitle:@"serial" forState:UIControlStateNormal];
    [serial setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [serial addTarget:self action:@selector(Serial) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:serial];
    
    
    UIButton * Concurrent = [[UIButton alloc] initWithFrame:CGRectMake(100, 200, 100, 50)];
    [Concurrent setTitle:@"Concurrent" forState:UIControlStateNormal];
    [Concurrent setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [Concurrent addTarget:self action:@selector(Concurrent) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:Concurrent];
    
    
    
    UIButton * after = [[UIButton alloc] initWithFrame:CGRectMake(100, 300, 100, 50)];
    [after setTitle:@"延时3秒执行" forState:UIControlStateNormal];
    [after setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [after addTarget:self action:@selector(after) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:after];
    
    
    UIButton * group = [[UIButton alloc] initWithFrame:CGRectMake(100, 400, 100, 50)];
    [group setTitle:@"若干任务执行完之后，想执行某任务" forState:UIControlStateNormal];
    [group setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [group addTarget:self action:@selector(group) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:group];
    
    
    
    UIButton * barrier = [[UIButton alloc] initWithFrame:CGRectMake(100, 500, 100, 50)];
    [barrier setTitle:@"barrier" forState:UIControlStateNormal];
    [barrier setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [barrier addTarget:self action:@selector(barrier) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:barrier];
    
    
    
    UIButton * apply = [[UIButton alloc] initWithFrame:CGRectMake(100, 600, 100, 50)];
